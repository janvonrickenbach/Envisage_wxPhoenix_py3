...
messages = [
    Message(
        ...
        " arithmetic; but you cannot have both at the same time."), Message(
    ...
    Message(
        ...
        " the solution is not beautiful, I know it is wrong."), Message(
            author="Tom Gilb",
    ...
    Message(
        ...
        " - to move in the opposite direction."), Message(
            author="Martin Fowler",
            text="Any fool can write code that a computer can understand. Good"
            " programmers write code that humans can understand."), Message(
